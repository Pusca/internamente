...
class Wpresidence_Single_Agent_Star_Reviews extends Widget_Base {
    ...
    public function get_name() {
        return 'Single_agent_star_reviews';
    }
    ...
    public function get_title() {
        return esc_html__('Single Agent Star Reviews', 'residence-elementor');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
                    '{{WRAPPER}} .wpestate_empty_wrapper' => 'align: {{VALUE}};',
                ],
				// 'separator' => 'after',
			]
		);
        ...
        $this->add_control(
            'text_color', [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .wpestate_empty_wrapper' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .property_ratings i' => 'color: {{VALUE}};',
                ],
            ]
        );
...
/**
  ...
  protected function render() {
    ...
    if ($post_id) {
        ...
        $ratings_string = wpestate_return_agent_reviews_bar( $post_id );

        if ( empty( $ratings_string ) ) {
            $ratings_string = '<div class="wpestate-no-reviews">'.esc_html__('No reviews yet', 'residence-elementor').'</div>';
        }
        
        echo wpestate_generate_empty_wrapper( $ratings_string );
    }
