...
$this->add_control(
    ...
    [
        ...
        'type'      => Controls_Manager::COLOR,
        'selectors' => [
            '{{WRAPPER}} .panel-body .listing_detail:not(:last-child)' => 'border-bottom: 1px solid {{VALUE}};',
        ],
        'condition' => [
            'show_separator' => 'yes',
        ],
...
$this->add_responsive_control(
    ...
    [
        ...
        'selectors'  => [
            '{{WRAPPER}} .panel-body .listing_detail:not(:last-child)' => 'padding-bottom: {{SIZE}}{{UNIT}}; margin-bottom: {{SIZE}}{{UNIT}};',
        ],
        'condition'  => [
            'show_separator' => 'yes',
        ],
...
$this->add_responsive_control(
    ...
    [
        ...
        'selectors' => [
            '{{WRAPPER}} .row' => 'margin-right: calc(-{{SIZE}}{{UNIT}} / 2); margin-left: calc(-{{SIZE}}{{UNIT}} / 2);',
            '{{WRAPPER}} .row > [class*="col-"]' => 'padding-right: calc({{SIZE}}{{UNIT}} / 2); padding-left: calc({{SIZE}}{{UNIT}} / 2);',
        ],
    ]
);
