...
class Wpresidence_Single_Post_Related_Posts extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Single Post Related Posts', 'residence-elementor');
    }
    ...
    public function get_icon() {
        return 'wpresidence-note eicon-archive-posts';
    }
...
/**
  ...
  protected function render() {
    ...
    if ($post_id) {
        ...
        echo wpestate_display_related_posts( $post_id, $settings );
