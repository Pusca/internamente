...
class Wpresidence_Recent_Items_SLider_v8 extends Widget_Base {
    ...
    public function get_name() {
        return 'Wpresidence_Recent_Items_SLider_v8';
    }
    ...
    public function get_title() {
        return __('Items Slider - Card V8 ', 'residence-elementor');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'default' => '',
            'selectors' => [
                '{{WRAPPER}} .property_unit_type6_title_wrapper h4' => 'display: {{VALUE}};',
            ],
                ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            'default' => '',
            'selectors' => [
                '{{WRAPPER}} .property_agent_unit_type6' => 'display: {{VALUE}};',
                '{{WRAPPER}} .property_listing_details6_grid_view' => 'margin-bottom:0px;',
            ],
                ]
        );
        ...
        $this->add_group_control(
           ...
           'global' => [
            ...
            'selector' => '{{WRAPPER}} .inforoom_unit_type6',
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .property_listing_details6_grid_view ' => 'margin-bottom: {{SIZE}}{{UNIT}};',
            ],
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .property_listing_details6_grid_view' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                '{{WRAPPER}} .property_unit_type6_title_wrapper_list ' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'default' => '',
            'selectors' => [
                '{{WRAPPER}} .property_agent_unit_type6' => 'border-color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'default' => '',
            'selectors' => [
                '{{WRAPPER}} .property_listing_details6_grid_view' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'default' => '',
            'selectors' => [
                '{{WRAPPER}} .inforoom_unit_type6 svg path' => 'fill: {{VALUE}}',
            ],
                ]
        );
